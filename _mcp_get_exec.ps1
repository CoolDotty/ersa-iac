...
$body = '{"jsonrpc":"2.0","id":61,"method":"tools/call","params":{"name":"get_execution","arguments":{"workflowId":"cNyZx8zOIOcEa4WT","executionId":"23883","includeData":true,"truncateData":1}}}'
try {
