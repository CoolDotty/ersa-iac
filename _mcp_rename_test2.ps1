...
$body = '{"jsonrpc":"2.0","id":51,"method":"tools/call","params":{"name":"update_workflow","arguments":{"workflowId":"8zph4MTUsZVGW147","operations":[{"type":"setWorkflowMetadata","name":"sync test"}]}}}'
try {
